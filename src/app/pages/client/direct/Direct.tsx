...
import { getDirectCreatePath, getDirectRoomPath, getHomePath } from '../../pathUtils';
...
export function Direct() {
  ...
  useEffect(() => {
    if (!alternativeSidebar) return;
    if (location.pathname.endsWith('/create') || location.pathname.endsWith('/create/')) return;
